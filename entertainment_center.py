...
toy_story = media.Movie(
    ...
    "1995",
    "John Lasseter",
    "A cowboy toy is profoundly threatened and jealous when a new \
...
avatar = media.Movie(
    ...
    "2009",
    "James Cameron",
    "A Paraplegic Marine becomes torn between following his orders \
...
inception = media.Movie(
    ...
    "2010",
    "Christopher Nolan",
    "A thief who can extract secrets from people's dreams goes on his \
    last mission: implant an idea.",
...
great_expectations = media.Movie(
    "Great Expectations",
    "111 min",
    "1998",
    "Alfonso Cuarón",
    "The hapless Finn as a painter in New York pursues his unrequited and \
    haughty childhood love.",
    ("http://upload.wikimedia.org/wikipedia/en/5/53/"
     "Great_expectations_poster.jpg"),
    "https://youtu.be/6bq8BsIZejE")

lovers_concerto = media.Movie(
    "Lover's Concerto",
    "106 min",
    "2002",
    "Han Lee",
    "Ji-Hwan departs on a long journey to find his old friends as he confronts \
...
interstellar = media.Movie(
    ...
    ("http://www.hollywoodreporter.com/sites/default/files/custom/Blog_Images/"
     "interstellar3.jpg"),
    "https://youtu.be/0vxOhd4qlnA")

leon_the_professional = media.Movie(
    "Léon: The Professional",
    "110 min",
    "1994",
    "Luc Besson",
    "Léon and Mathilda form an unusual relationship, as she becomes \
    his protégée and learns the assassin's trade.",
...
movies = [toy_story, avatar, inception, breakfast_at_tiffanys,
          great_expectations, lovers_concerto, interstellar,
          leon_the_professional, the_departed]
